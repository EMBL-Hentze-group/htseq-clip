results_DEWSeq <- function(object, contrast, name, 
                           listValues=c(1,-1),
                           cooksCutoff, test,
  ...
  # L RTResults <- "LRTPvalue" %in% names(mcols(object))
  ...
  # recalculate p-values, now only right sided test is enough
  if(useT){
  ...
  # the functions below can be removed
