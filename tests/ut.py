...
class TestProcessMethods(unittest.TestCase):
    ...
    def test_process(self):
        ...
        gtfCLIP.fOutput = "UnitTestOutput/testProcess/test.bed"
    ...
    def test_process_empty(self):
        ...
        gtfCLIP.fOutput = "UnitTestOutput/testProcess/test_empty.bed"
        gtfCLIP.geneType = "gene_type"
...
class TestJunctionMethods(unittest.TestCase):
    ...
    def test01_junction(self):
        ...
        bedCLIP.fInput = "testJunction/test01.bed"
        bedCLIP.fOutput = "UnitTestOutput/testJunction/test01.txt"
        bedCLIP.fCompare = "testJunction/test01_junction.bed"
    ...
    def test02_junction(self):
        ...
        bedCLIP.fInput = "testJunction/test02.bed"
        bedCLIP.fOutput = "UnitTestOutput/testJunction/test02.txt"
        bedCLIP.fCompare = "testJunction/test02_junction.bed"
    ...
    def test03_junction(self):
        ...
        bedCLIP.fInput = "testJunction/test03.bed"
        bedCLIP.fOutput = "UnitTestOutput/testJunction/test03.txt"
        bedCLIP.fCompare = "testJunction/test03_junction.bed"
    ...
    def test04_junction(self):
        ...
        bedCLIP.fInput = "testJunction/test04.bed"
        bedCLIP.fOutput = "UnitTestOutput/testJunction/test04.txt"
        bedCLIP.fCompare = "testJunction/test04_junction.bed"
...
class TestCountMethods(unittest.TestCase):
    ...
    def test01_count(self):
        ...
        bedCLIP.fInput = "testCount/test01.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test01.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.testCount.sorted.bed.gz"
        bedCLIP.choice = "o"
    ...
    def test02_count(self):
        ...
        bedCLIP.fInput = "testCount/test02.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test02.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.testCount.sorted.bed.gz"
        bedCLIP.choice = "o"
    ...
    def test03_count(self):
        ...
        bedCLIP.fInput = "testCount/test03.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test03.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.testCount.sorted.bed.gz"
        bedCLIP.choice = "o"
    ...
    def test04_count(self):
        ...
        bedCLIP.fInput = "testCount/test04.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test04.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.testCount.sorted.bed.gz"
        bedCLIP.choice = "o"
    ...
    def test05_count(self):
        ...
        bedCLIP.fInput = "testCount/test05.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test05.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.testCount.sorted.bed.gz"
        bedCLIP.choice = "o"
    ...
    def test06_count(self):
        ...
        bedCLIP.fInput = "testCount/test01.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCount/test06.txt"
        bedCLIP.fCompare = "testCount/Homo_sapiens.GRCh37.82.sorted.bed.gz"
        bedCLIP.choice = "a"
...
class TestSlidingWindowMethods(unittest.TestCase):
    ...
    def test_01(self):
        ...
        gtfCLIP.fInput = "testSlidingWindow/test01.bed"
        gtfCLIP.fOutput = "UnitTestOutput/testSlidingWindow/test01.bed"
        gtfCLIP.windowSize = 100
        gtfCLIP.windowStep = 50
    ...
    def test_02(self):
        ...
        gtfCLIP.fInput = "testSlidingWindow/test02.bed"
        gtfCLIP.fOutput = "UnitTestOutput/testSlidingWindow/test02.bed"
        gtfCLIP.windowSize = 100
        gtfCLIP.windowStep = 50
...
class TestCountSWMethods(unittest.TestCase):
    ...
    def test01(self):
        ...
        bedCLIP.fInput = "testCountSW/test01_cl.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCountSW/test01.txt"
        bedCLIP.fCompare = "testCountSW/test01.bed"
    ...
    def test02(self):
        ...
        bedCLIP.fInput = "testCountSW/test02_cl.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCountSW/test02.txt"
        bedCLIP.fCompare = "testCountSW/test01.bed"
    ...
    def test03(self):
        ...
        bedCLIP.fInput = "testCountSW/test01_cl.bed"
        bedCLIP.fOutput = "UnitTestOutput/testCountSW/test03.txt"
        bedCLIP.fCompare = "testCountSW/test02.bed"
...
class TestToDexSeqMethods(unittest.TestCase):       
    ...
    def test01(self):
        ...
        bedCLIP.fInput = "testToDexSeq/test01.txt"
        bedCLIP.fOutput = "UnitTestOutput/testToDexSeq/test01.dex.txt"
    ...
    def test02(self):
        ...
        bedCLIP.fInput = "testToDexSeq/test02.txt"
        bedCLIP.fOutput = "UnitTestOutput/testToDexSeq/test02.dex.txt"
