...
def main():
    ...
    extract.add_argument('-e','--mate',metavar='mate info',dest='mate',help='for paired end sequencing, select the read/mate to extract the crosslink sites from.\n Allowed inputs: {}'.format(', '.join([str(i) for i in mates])),type=int,choices=mates,required=True) # make it required ?
