...
def main(argv):
    ...
    # annotation
    ahelp = 'annotation: flattens (BED format) the given annotation file (GFF format)'
    ...
    annotation.add_argument('-o','--output',metavar = 'output file',dest='output',help='output file (.bed/.bed.gz, default: print to console)',default=None,type=str)
    ...
    createSlidingWindows.add_argument('-o','--output',metavar = 'output file',dest='output',help='output annotation sliding windows file (.bed/.bed.gz, default: print to console)',default=None,type=str)
    ...
    extract.add_argument('-e','--mate',metavar='mate info',dest='mate',help='select which read to extract the crosslink sites from. Allowed choices: {}'.format(', '.join([str(i) for i in mates])),type=int,choices=mates,required=True) # make it required ?
    ...
    countSlidingWindows = subps.add_parser('countSlidingWindows', description=cswhelp) # help='count sliding windows',
